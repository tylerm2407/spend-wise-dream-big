...
import { Home, BarChart3, ShoppingCart, Lightbulb, TrendingUp } from 'lucide-react';
...
export function BottomTabBar() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-tabbar border-t border-tabbar-border pb-[env(safe-area-inset-bottom)]">
